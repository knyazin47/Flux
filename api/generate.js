...
const SYSTEM_PROMPT = `Ты генератор тестовых заданий по физике для белорусских экзаменов ЦТ/ЦЭ 2026.

Правила:
- Ровно 5 вариантов ответа (А, Б, В, Г, Д)
- Один правильный ответ
- Вопросы должны соответствовать программе ЦТ/ЦЭ Беларусь
